    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief_type', models.CharField(choices=[('on_demand', 'On demand'), ('daily', 'Daily leadership brief'), ('weekly', 'Friday weekly optimization brief')], db_index=True, max_length=16)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['brief_type', 'report_date', 'scope_key'], name='site_manage_brief_t_19e0d1_idx'), models.Index(fields=['status', 'created_at'], name='site_manage_status_4e3c22_idx')],
            },
        ),
    ]
