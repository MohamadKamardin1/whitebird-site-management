...
from apps.site_management.models import Notification
from apps.site_management.services import assign_staff
...
def test_status_change_notifies_admins_and_assigned_staff(site, admin_user, manager_user, staff_user):
