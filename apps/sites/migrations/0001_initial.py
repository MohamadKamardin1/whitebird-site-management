    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#6b7280', help_text='Hex colour (e.g. #10b981) used by client dashboards.', max_length=9)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sites', to='sites.sitestatus')),
                ('site_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sites', to='sites.sitetype')),
            ],
            options={
                'verbose_name': 'Site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('role', models.CharField(choices=[('site_manager', 'Site Manager'), ('staff', 'Staff')], max_length=24)),
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staff_assignments', to='sites.site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departments', to='sites.site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('operational', 'Operational'), ('under_maintenance', 'Under Maintenance'), ('retired', 'Retired')], default='operational', max_length=24)),
                ('is_active', models.BooleanField(default=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assets', to='sites.assetcategory')),
        ...
        migrations.AddIndex(
            model_name='site',
            index=models.Index(fields=['status', 'site_type'], name='sites_site_status__c9f153_idx'),
        ),
        migrations.AddIndex(
            model_name='site',
            index=models.Index(fields=['is_active', 'status'], name='sites_site_is_acti_120ebd_idx'),
        ),
