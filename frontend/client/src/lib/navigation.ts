...
export const primaryNavigation: NavEntry[] = [
  ...
  { href: "/remuneration/register", label: "Monthly remuneration register", icon: WalletCards, roles: ["hr", "general_supervisor", "assistant_general_supervisor"] },
  ...
  { href: "/hr/people", label: "People registry", icon: UsersRound, roles: ["hr", "general_supervisor"] },
  { href: "/hr/assignments", label: "Assignments & shifts", icon: ClipboardList, roles: ["hr"] },
  { href: "/trainees", label: "Trainee management", icon: GraduationCap, roles: ["hr", "site_supervisor", "general_supervisor", "assistant_general_supervisor", "zone_supervisor"] },
  { href: "/attendance", label: "Attendance", icon: ClipboardCheck, roles: ["general_supervisor", "assistant_general_supervisor", "zone_supervisor", "site_supervisor"] },
  { href: "/remuneration", label: "Monthly remuneration", icon: WalletCards, roles: ["site_supervisor", "hr"] },
  { href: "/cleanliness", label: "Daily cleanliness", icon: ClipboardCheck, roles: ["general_supervisor", "assistant_general_supervisor", "zone_supervisor", "site_supervisor"] },
  { href: "/supervision/timetable", label: "My timetable", icon: CalendarDays, roles: ["assistant_general_supervisor", "zone_supervisor"] },
  { href: "/supervision/roster", label: "My supervision checklist", icon: ClipboardList, roles: ["assistant_general_supervisor", "zone_supervisor"] },
  { href: "/operations/issues", label: "Issues & jobs", icon: HardHat, roles: ["general_supervisor", "assistant_general_supervisor", "zone_supervisor", "site_supervisor"] },
  { href: "/store-control", label: "Company inventory", icon: PackageCheck, roles: ["store_manager", "system_admin"] },
  { href: "/stores", label: "Stores & stock", icon: PackageSearch, roles: ["store_manager", "general_supervisor", "assistant_general_supervisor", "zone_supervisor", "site_supervisor"] },
